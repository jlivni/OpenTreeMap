...
var tm = {
    ...
    */
    ...
    display_summaries : function(summaries){
        ...
        $(".heritage_tree_count").html(tm.addCommas(parseInt(summaries.heritage_count)));
        var el = $("#heritage_count_bar");
        summaries.heritage_count ? el.show() : el.hide();
    ...
    updateEditableServerCall: function(value, settings) {
        ...
        //else {
            ...
            if ($.inArray(settings.model, ["TreeAlert","TreeAction","TreeFlags","TreeFauna"]) >=0) {
