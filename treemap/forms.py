...
class TreeAddForm(forms.Form):
    ...
    edit_latitude = forms.CharField(max_length=200, required=False, initial="Latitude")
    edit_longitude = forms.CharField(max_length=200, required=False, initial="Longitude")
